                ...
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                    <div>
                      ...
                      <Input type="text" placeholder="Your full name" required className="rounded-xl" />
                    </div>
                    <div>
                      <Label>Email *</Label>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                    <div>
                      <Label>Phone</Label>
                      <Input type="tel" placeholder="(248) 000-0000" className="rounded-xl" />
                    </div>
                    <div>
                      <Label>Subject *</Label>
                      <Input type="text" placeholder="How can we help?" required className="rounded-xl" />
                    </div>
                  </div>
                  <div className="mb-8">
                    <Label>Message *</Label>
                    <Textarea placeholder="Tell us about your project..." required className="min-h-[160px] rounded-xl" />
                  </div>
            ...
            <AnimateOnScroll delay={0.1} className="lg:col-span-4 lg:col-start-9">
              ...
              <div className="mt-10 pt-10 border-t border-border">
                ...
                <div className="flex gap-3">
                  <a href={companyInfo.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground hover:bg-brand flex items-center justify-center transition-colors text-white text-xs font-bold">f</a>
                  <a href={companyInfo.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground hover:bg-brand flex items-center justify-center transition-colors text-white text-xs font-bold">ig</a>
                </div>
              </div>
            </AnimateOnScroll>
          </div>
