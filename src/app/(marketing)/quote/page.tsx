              ...
              <div className="bg-card rounded-2xl border border-border p-8 lg:p-12">
                ...
                <form onSubmit={e => e.preventDefault()}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                    <div><Label htmlFor="first-name">First Name *</Label><Input id="first-name" type="text" placeholder="First name" required className="rounded-xl" /></div>
                    <div><Label htmlFor="last-name">Last Name *</Label><Input id="last-name" type="text" placeholder="Last name" required className="rounded-xl" /></div>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                    <div><Label htmlFor="quote-email">Email *</Label><Input id="quote-email" type="email" placeholder="you@example.com" required className="rounded-xl" /></div>
                    <div><Label htmlFor="quote-phone">Phone *</Label><Input id="quote-phone" type="tel" placeholder="(248) 000-0000" required className="rounded-xl" /></div>
                  </div>
                  <div className="mb-5">
                    <Label htmlFor="address">Property Address *</Label>
                    <Input id="address" type="text" placeholder="Street address, city, state, zip" required className="rounded-xl" />
                  </div>
                  <div className="mb-5">
                  ...
                  <div className="mb-5">
                    ...
                    <Textarea id="project-desc" placeholder="Describe your project, goals, timeline..." required className="min-h-[140px] rounded-xl" />
                  </div>
